  ...
  render() {
    return (
      ...
      <div className="footer slds-m-horizontal--large slds-m-top--xx-large">
        <div>
          <h2>Version Notes</h2>
          <p>Version 2.1: The "Verified Events/All Events" button was modified to make it clearer what type of events are currently displayed. The "Export to CSV" button has been updated to clarify that it only exports columns visible on the homepage. A stable link to a CSV dump of the entire FRBCAT database has been added (see header text). </p>
          <p>Version 2.0: The updated version of the catalogue is now capable of parsing and automatically ingesting FRBs into the catalogue received as xml VOEvents over the VOEvent Network. See (<a href="http://adsabs.harvard.edu/abs/2017arXiv171008155P">Petroff et al., 2017</a>) for more details.</p>

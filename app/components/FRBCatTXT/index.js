...
class FRBCatTXT extends React.Component {
    render() {
        return (
          ...
          <p>
This catalogue contains up to date information for the published population of Fast Radio Bursts (FRBs). This site is maintained by the FRBCAT team and is updated as new sources are published or refined numbers become available. Sources can now be added to the FRBCAT automatically via the VOEvent Network, details of this process are given in <a href="">Petroff et al., 2017</a>. FRBs confirmed via publication, or received with a high importance score over the VOEvent Network, are given 'Verified' status and are shown on the default homepage; to see all events (including unverified candidates received via the VOEvent Network) toggle the "Show all/Show verified" button below.
          </p>
          <p>
          ...
          <p>
          You may use the data presented in this catalogue for publications; however, we ask that you cite the paper, when available (<a href="http://adsabs.harvard.edu/abs/2016PASA...33...45P">Petroff et al., 2016</a>) and provide the url ([url will go here]). Any issues relating to the use of the catalogue should be addressed to FRBCAT team (primary contact: Emily Petroff).
          </p>
          </div>
        );
    }
